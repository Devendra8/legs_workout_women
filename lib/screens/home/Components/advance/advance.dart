                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "30 days advance challenge is the most difficult challenge which will help the body to shape the hips fat as fast as possible. This exercises will also make the hips very strong.",
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                              fontFamily: 'Roboto',
