...
class BeginnerExercisePage extends StatefulWidget {
  ...
  const BeginnerExercisePage({
    required this.exerciseSet,
  });

  @override
  _BeginnerExercisePageState createState() => _BeginnerExercisePageState();
}

class _BeginnerExercisePageState extends State<BeginnerExercisePage> {
