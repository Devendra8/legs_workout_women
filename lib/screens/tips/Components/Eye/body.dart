...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    return TimelineTile(
      isFirst: widget.eyeSet.isFirst,
      isLast: widget.eyeSet.isLast,
                    ...
                    Flexible(
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 24,
                              color: Color.fromARGB(255, 64, 72, 153),
